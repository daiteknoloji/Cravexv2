...
export default class DeviceListener {
    ...
    public start(matrixClient: MatrixClient): void {
        // Cravex: Disable device verification prompts
        // Device verification and cross-signing toasts are disabled
        if (SdkConfig.get("disable_device_verification")) {
            logger.info("Device verification is disabled in config - not starting DeviceListener");
            return;
        }
